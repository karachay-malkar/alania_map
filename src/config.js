export const CONFIG = Object.freeze({
  ...
  iconMountainsUrl: 'data/mountain-icons-1500.geojson',
  atlasManifestUrl: 'assets/mountains/atlas-manifest.json',
  iconAtlasUrl: 'assets/mountains/mountain-atlas.png',
  bearing: 180,
  pitch: 25,
  minZoom: 6.2,
  maxZoom: 15.5,
