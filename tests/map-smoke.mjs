...
try {
  ...
  assert.ok(!diagnostics.sourceIds.includes('snow-permanent'));
  ...
  assert.ok(!diagnostics.transport.archives.some(item => item.sourceId === 'snow-permanent'));
